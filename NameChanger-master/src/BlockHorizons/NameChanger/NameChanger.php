...
class NameChanger extends PluginBase implements Listener {
	...
	public function onJoin(PlayerJoinEvent $event) {
		if(isset($this->userNameChanged[$event->getPlayer()->getName()])) {
			...
			$event->getPlayer()->sendMessage(TextFormat::AQUA . "§l§c##IMPORTANT##§r§b If you want your old name back! hit pause, hit settings, go to the Name Changing Menu, Enter your old name and hit confirm! voila!");
		}
	}
